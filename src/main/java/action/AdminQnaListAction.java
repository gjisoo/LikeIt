...
public class AdminQnaListAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		int count = AdminBbsDAO.getCount(searchType, searchValue);
		...
		BbsVO[] ar = AdminBbsDAO.getList(searchType, searchValue, String.valueOf(page.getBegin()), String.valueOf(page.getEnd()));
