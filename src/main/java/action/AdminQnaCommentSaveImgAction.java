...
public class AdminQnaCommentSaveImgAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			String realPath = application.getRealPath("/qna_comment_upload");
		...
		return "/admin_qnacommentsaveImg.jsp"; // 이미지의 경로(url)를 json형식을 반환!
	}
