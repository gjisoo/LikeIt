          ...
          <div class="u-layout" style="">
            <div class="u-layout-row" style="">
              <div class="u-align-left u-container-style u-grey-5 u-layout-cell u-right-cell u-size-60 u-size-xs-60 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1"><span class="u-file-icon u-icon u-icon-1"><img src="image_upload/${pvo.file_name }" style="width:750px;"></span>
                    ...
                    <table class="u-table-entity">
                      ...
                      <tbody class="u-table-body">
                        <tr style="height: 68px;">
                          ...
                          <td class="u-border-2 u-border-palette-1-light-1 u-table-cell">${requestScope.pvo.p_name }</td>
                        </tr>
                        <tr style="height: 66px;">
                          <td class="u-border-2 u-border-palette-1-base u-first-column u-grey-5 u-table-cell u-table-cell-3">작가명</td>
                          <td class="u-border-2 u-border-palette-1-light-1 u-table-cell"><a href="Controller_admin?type=member_detail&mem=${requestScope.pvo.m_idx }" >${requestScope.pvo.m_id }</a></td>
                        </tr>
                        <tr style="height: 66px;">
                          <td class="u-border-2 u-border-palette-1-base u-first-column u-grey-5 u-table-cell u-table-cell-3">구매자</td>
                          <td class="u-border-2 u-border-palette-1-light-1 u-table-cell"><a href="Controller_admin?type=member_detail&mem=${requestScope.avo.m_idx }" >${requestScope.avo.m_id }</a></td>
                        </tr>
                        ...
                        <tr style="height: 259px;">
                          ...
                          <td class="u-border-2 u-border-palette-1-light-1 u-table-cell">${requestScope.pvo.p_info }</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  <a href="javascript:history.back();" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-dark-2 u-palette-1-base u-radius-5 u-btn-1">돌아가기</a>
                  <c:if test="${pvo.p_status eq 0 }">
                  ...
                  <a href="Controller_admin?type=admin_modify_page&product=${pvo.p_idx }" class="u-border-none u-btn u-btn-round u-button-style u-hover-palette-1-dark-2 u-radius-6 u-btn-4" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">수정</a>
                </div>
              </div>
            </div>
          </div>
