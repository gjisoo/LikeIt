              ...
              <div class="u-align-left u-container-style u-grey-5 u-layout-cell u-right-cell u-size-60 u-size-xs-60 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1"><span class="u-file-icon u-icon u-icon-1"><img src="image_upload/${vo.file_name }" style="width:750px;"></span>
                  <div class="u-table u-table-responsive u-table-1">
                      ...
                      <input type="hidden" name="type" value="admin_modify"/>
                    <table class="u-table-entity">
                      ...
                      <tbody class="u-table-body">
                        ...
                        <tr style="height: 66px;">
                          ...
                          <td class="u-border-2 u-border-palette-1-light-1 u-table-cell"><input type="text" size= "80" name="p_artist" value="${requestScope.vo.m_id }" /></td>
                        </tr>
                        <tr style="height: 63px;">
                          ...
                          <c:if test="${not empty vo.p_s_price and vo.p_status == 0 or vo.p_status == 1 or vo.p_status == 4 or vo.p_status == 5}">
			 					<input type="text" size= "80" name="p_s_price" value="${requestScope.vo.p_s_price }" />
		 					</c:if>
		 					<c:if test="${not empty avo.a_price and avo.a_status != 0}">
		  				 		 <input type="text" size= "80" name="a_price" value="${requestScope.avo.a_price }" />
		 					</c:if>
