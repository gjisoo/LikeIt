    ...
    <section class="u-align-center u-clearfix u-white u-section-1" id="sec-0bbb">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-border-3 u-border-grey-30 u-form u-radius-12 u-form-1">
          ...
          <form action="Controller" class="u-clearfix u-form-horizontal u-form-spacing-0 u-inner-form" style="padding: 0px;" source="email">
            <div class="u-form-text u-form-group u-label-none">
              <label for="email-c026" class="u-label">search</label>
              <input type="text" placeholder="크리에이터 또는 제목" id="search" name="searchValue" class="u-border-4 u-border-black u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-radius-15" required="">
            </div>
            <div class="u-form-group u-form-submit u-label-none">
              <button type="button" onclick="exe(this.form)" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-grey-70 u-radius-12 u-btn-1">검색</button>
              	<input type="hidden" name="type" value="hold_search">
            </div>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-expanded-width u-list u-list-1">
          <div class="u-repeater u-repeater-1">
            ...
            <c:forEach var="pvo" items="${requestScope.ar }">
