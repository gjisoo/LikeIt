      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-expanded-width u-table u-table-responsive u-table-1">
          <table class="u-table-entity u-table-entity-1">
            ...
            <c:forEach var="vo" items="${requestScope.q_list }">
              <tr style="height: 55px;">
                <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell">${vo.q_idx }</td>
                <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell"><a href="Controller?type=admin_qnaview&q_idx=${vo.q_idx }">${vo.q_title }</a></td>
            ...
            <tfoot>
					<tr>
						...
						<ol class="paging">
							...
							<c:if test="${page.startPage >= page.pagePerBlock }">
								<li><a href="Controller?type=admin_qna&cPage="${page.startPage-page.pagePerBlock }>&lt;</a></li>
							</c:if>
							<c:forEach begin="${page.startPage }" end="${page.endPage }" varStatus="st">
								...
								<c:if test="${page.nowPage ne st.index }">
									<li><a href="Controller?type=admin_qna&cPage=${st.index }">${st.index }</a></li>
								</c:if>
							</c:forEach>	
