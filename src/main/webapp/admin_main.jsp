...
<link rel="stylesheet" href="main.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-palette-5-light-2 u-sticky" id="sec-0db4" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-white u-section-1" id="carousel_8da0">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-1">
          <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-hover-palette-1-light-2 u-text-palette-1-base u-btn-1" href="Controller_admin?type=admin_product">&nbsp;​&nbsp;상품관리 </a>
        </h2>
        <div class="u-expanded-width u-list u-list-1">
          <div class="u-repeater u-repeater-1">
            <div class="u-align-center u-container-align-center u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1">
                <div class="u-container-style u-group u-palette-1-light-2 u-shape-circle u-group-1" data-href="Controller?type=admin_product&select=0">
                  <div class="u-container-layout u-valign-middle u-container-layout-2">
                    <h3 class="u-text u-text-default u-text-2" data-animation-name="counter" data-animation-event="scroll" data-animation-duration="3000">${requestScope.reg_count }</h3>
                  </div>
                </div>
                <h5 class="u-align-center u-text u-text-3">판매 신청 상품</h5>
              </div>
            </div>
            <div class="u-align-center u-container-align-center u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-valign-top u-container-layout-3">
                <div class="u-container-style u-group u-palette-1-light-2 u-shape-circle u-group-2" data-href="Controller?type=admin_product&select=1">
                  <div class="u-container-layout u-valign-middle u-container-layout-4">
                    <h3 class="u-text u-text-default u-text-4" data-animation-name="counter" data-animation-event="scroll" data-animation-duration="3000">${requestScope.hold_count }</h3>
                  </div>
                </div>
                <h5 class="u-align-center u-text u-text-5">판매 대기 상품</h5>
              </div>
            </div>
            <div class="u-align-center u-container-align-center u-container-style u-list-item u-repeater-item">
              <div class="u-container-layout u-similar-container u-valign-top u-container-layout-5">
                <div class="u-container-align-center u-container-style u-group u-palette-1-light-2 u-shape-circle u-group-3" data-href="Controller?type=admin_product&select=2">
                  <div class="u-container-layout u-valign-middle u-container-layout-6">
                    <h3 class="u-text u-text-default u-text-6" data-animation-name="counter" data-animation-event="scroll" data-animation-duration="3000">${requestScope.sale_count }</h3>
                  </div>
                </div>
                <h5 class="u-align-center u-text u-text-7">판매 진행 상품</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="u-clearfix u-expanded-width u-gutter-20 u-layout-wrap u-layout-wrap-1">
          <div class="u-layout">
            <div class="u-layout-row">
              <div class="u-container-style u-layout-cell u-palette-1-light-3 u-radius-40 u-shape-round u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <h2 class="u-text u-text-1">
                    <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-1" href="Controller_admin?type=member"> &nbsp;<span class="u-file-icon u-icon u-icon-1"><img src="images/10523510.png" alt=""></span>&nbsp;회원 관리
                    </a>
                  </h2>
                  <div class="u-list u-list-1">
                    <div class="u-repeater u-repeater-1">
                      <div class="u-align-center u-border-2 u-border-white u-container-style u-list-item u-repeater-item u-list-item-1">
                        <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-2"><span class="u-file-icon u-icon u-icon-2"><img src="images/681443.png" alt=""></span>
                          <h1 class="u-text u-text-default u-title u-text-2" data-animation-name="counter" data-animation-event="scroll" data-animation-duration="3000">${requestScope.total_memberCount }</h1>
                          <p style="text-align:center">전체 회원 수</p>
                        </div>
                      </div>
                      <div class="u-align-center u-border-2 u-border-white u-container-style u-list-item u-repeater-item u-list-item-2">
                        <div class="u-container-layout u-similar-container u-valign-middle u-container-layout-3"><span class="u-file-icon u-icon u-icon-3"><img src="images/5368901.png" alt=""></span>
                          <h1 class="u-text u-text-default u-title u-text-4" data-animation-name="counter" data-animation-event="scroll" data-animation-duration="3000">+${requestScope.new_memberCount }</h1>
                          <p style="text-align:center">신규 회원 수</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="u-container-style u-layout-cell u-palette-1-light-3 u-radius-40 u-size-30 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-4">
                  <h2 class="u-text u-text-default u-text-6">
                    <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-2" href="Controller_admin?type=admin_qna"><span class="u-file-icon u-icon"><img src="images/3382313.png" alt=""></span>&nbsp;Q&amp;A<span style="font-size: 1.5rem;">
                  ...
                  <div class="u-list u-list-2">
                    ...
                    <c:forEach var="vo" items="${requestScope.qvo }" varStatus="st" begin="0" end="3">
                      <div class="u-container-style u-list-item u-repeater-item">
                        <div class="u-container-layout u-similar-container u-container-layout-5"><span class="u-file-icon u-icon u-icon-5"><img src="images/10473624.png" alt=""></span>
                          <p class="u-text u-text-7"><a href="Controller?type=admin_qnaview&q_idx=${vo.q_idx }">${vo.q_title }&nbsp;</a></p>
                        </div>
                      </div>
                     </c:forEach>
