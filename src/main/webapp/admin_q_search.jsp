...
<link rel="stylesheet" href="qna.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-palette-5-light-2 u-sticky" id="sec-0db4" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-ae65">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-form u-form-1">
          <form action="Controller_admin" class="u-clearfix u-form-horizontal u-form-spacing-15 u-inner-form" style="padding: 15px" source="email">
            <div class="u-form-group u-form-select u-label-none u-form-group-1">
              ...
              <div class="u-form-select-wrapper">
                <select id="select-8570" name="searchType" class="u-input u-input-rectangle u-radius-50">
                  <option value="0" data-calc="q_idx">번호</option>
                  <option value="1" data-calc="q_title">제목</option>
                  <option value="2" data-calc="q_writer">작성자</option>
            ...
            <input type="hidden" value="admin_q_search" name="type">
            <input type="hidden" name="formServices" value="3049711d18d3946fbccbc1211c9aced1">
          </form>
        </div>
      </div>
    </section>
    <section class="u-clearfix u-section-2" id="sec-f4b4">
          ...
          <table class="u-table-entity u-table-entity-1">
            ...
            <thead class="u-grey-50 u-table-header u-table-header-1">
              <tr style="height: 53px;">
                <th class="u-border-1 u-border-grey-50 u-table-cell">번호</th>
                <th class="u-border-1 u-border-grey-50 u-table-cell">제목</th>
                <th class="u-border-1 u-border-grey-50 u-table-cell">작성자</th>
                <th class="u-border-1 u-border-grey-50 u-table-cell">작성일</th>
                <th class="u-border-1 u-border-grey-50 u-table-cell">조회수</th>
              </tr>
            </thead>
            <tbody class="u-table-body">
            <c:forEach var="vo" items="${requestScope.q_search }">
              <tr style="height: 55px;">
                <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell">${vo.q_idx }</td>
                <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell"><a href="Controller_admin?type=admin_qnaview&q_idx=${vo.q_idx }">${vo.q_title }</a></td>
                <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell">${vo.q_writer }</td>
                <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell">${vo.q_date }</td>
                <td class="u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell">${vo.q_hit }</td>
              </tr>
             </c:forEach>
            ...
            <tfoot>
					<tr>
						...
						<ol class="paging">
							...
							<c:if test="${page.startPage >= page.pagePerBlock }">
								<li><a href="Controller?type=admin_q_search&cPage="${page.startPage-page.pagePerBlock }>&lt;</a></li>
							</c:if>
							<c:forEach begin="${page.startPage }" end="${page.endPage }" varStatus="st">
								...
								<c:if test="${page.nowPage ne st.index }">
									<li><a href="Controller?type=admin_q_search&cPage=${st.index }&searchType=${requestScope.searchType }&searchValue=${requestScope.searchValue }">${st.index }</a></li>
								</c:if>
							</c:forEach>	
